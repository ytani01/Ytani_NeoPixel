 ...
 */
#ifndef _MODE_SET_TIMER_H_
#define _MODE_SET_TIMER_H_

#include "ModeBase.h"

typedef unsigned long msec_t;

class ModeSetTimer: public ModeBase {

public:
  ModeSetTimer(Ytani_NeoPixel *leds, Button *btn,
